...
public class ProductoBusiness : IProductoBusiness
{
    ...
    public async Task CreateProducto(Models.Producto producto)
    {
        ...
        {
            Producto = new Productos.Producto  // este es el que generó el .proto
            {
                Id = producto.Id,
    ...
    public async Task<List<Models.Producto>> GetAllProductos()
    {
        ...
        return response.Productos
            .Select(p => new Models.Producto    // tu modelo interno del cliente
            {
                Id = p.Id,
                Nombre = p.Nombre,
    ...
    {
        var request = new GetProductoByIdRequest
        {
            Id = id
        };

        var response = await _client.GetProductoByIdAsync(request);
    ...
    {
        var request = new DeleteProductoRequest
        {
            Id = id
        };

        await _client.DeleteProductoAsync(request);
    }
